    ...
    <div className="w-full p-6 md:p-8 lg:p-10">
      <Card className="shadow-lg rounded-lg overflow-hidden">
        <CardHeader className="bg-white px-6 py-4 border-b border-gray-200 flex flex-row items-center justify-between">
          <CardTitle className="text-2xl font-bold text-gray-900">Auto Debit Registration List</CardTitle>
          <Button
              ...
              <Table>
                ...
                <TableBody>
                  {sampleCustomers.map((customer, index) => (
                    <TableRow key={customer.registrationId} className="hover:bg-gray-50 transition-colors">
                      <TableCell className="px-4 py-2 font-medium text-gray-800 text-sm">
                        {customer.customerName}
                      </TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.customerId}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.accountNo}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.accountType}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.billNumber}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.billCode}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.billType}</TableCell>
                      ...
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.startDate}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.nextExecutionDate}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.scheduleType}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.scheduleUnit}</TableCell>
                      <TableCell className="px-4 py-2 text-gray-700 text-sm">{customer.createdAt}</TableCell>
                      <TableCell className="px-4 py-2">{getStatusBadge(customer.status)}</TableCell>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => handleEdit(customer.registrationId)}
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => handleDelete(customer.registrationId)}
